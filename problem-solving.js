...
// task 7 : Implement a simple JavaScript calculator. The calculator should take two numbers and an operator (+, -, *, /) as input and return the result of the operation.
  ...
  const number2 = 5;
  const operation = '*';
  const output5 = calculator(number1, operation, number2);
  console.log(output5);
